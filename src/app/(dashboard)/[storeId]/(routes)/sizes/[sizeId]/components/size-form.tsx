...
export const SizeForm = ({ initialData }: SizeFormProps) => {
  ...
  const onSubmit = async (data: SizeFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await ky.patch(`/api/${params.storeId}/sizes/${params.sizeId}`, {
          json: data,
        });
      } else {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormMessage />
                  <FormDescription>
                    The size slug used to generate the size URL or filter.
                    <br /> Eg.: <code>{"my.store/sizes/{slug}"}</code>,{" "}
                    <code>{"my.store/products?size={slug}"}</code>
                  </FormDescription>
                </FormItem>
              )}
            />
